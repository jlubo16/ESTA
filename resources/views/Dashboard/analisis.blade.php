            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $analisis['categoria']->name }}</td>
                                    <td>${{ number_format($analisis['total'], 2) }}</td>
                                    <td>{{ number_format($analisis['porcentaje'], 1) }}%</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <strong>Ingresos:</strong> {{ $tendencias_mensuales['analisis']['ingresos']['interpretacion'] ?? 'No disponible' }}
                        </div>
                        <div class="mb-3">
                            <strong>Gastos:</strong> {{ $tendencias_mensuales['analisis']['gastos']['interpretacion'] ?? 'No disponible' }}
                        </div>
                        @endif
                    </div>
                </div>
